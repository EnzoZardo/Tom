...
public class VariableDeclaration extends Statement
{
    ...
    public static VariableDeclaration parse(Parser parser)
    {
        ...
        if (parser.peekIs(TokenType.INTERROGATION))
        {
            parser.consume();
            if (isConstant)
                throw new ParsingException("Não podemos declarar uma constante sem valor.");
        ...
        return VariableDeclaration.create(value, type, identifier, isConstant);
    }
