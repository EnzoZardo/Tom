...
{
    public static Contains<StringValue> build(RuntimeValue left, StringValue right)
    {
        if (left.type != ValueType.String)
        {
            throw new InvalidBinaryOperation("Valor não permitido para ser verificado se está em texto.");
        }

        return new StringContainsString(right, (StringValue) left);
    }
}